  ...
  return (
    <div className="relative">
      ...
      <textarea
        ...
        rows={5}
        className="w-full px-4 py-2 pr-10 rounded-md bg-gray-800 border border-gray-600 text-white placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-primary custom-scroll-hide overflow-auto"
      />
